...
class FileAttente
{
	...
	//	Intrant : prend un pointeur du noeud et l'identifie comme le nouveau premier de la list. 					
...
public:				             
	...
	FileAttente();    
	//	Intrant : Ostream effectue l'affichage des clients de la list.
	...
	//	Intrant : -le nombre de place de la	réservation. -la/les section(s) du client.
